"""OAuth 2.0 client-credentials authentication for the LibInsight API."""
...
class SpringshareAuth:
    """Obtain OAuth2 access tokens for the LibInsight API using Basic Auth."""
    ...
    def get_token(self) -> dict | None:
        ...
        try:
            ...
            print(f"Error getting token: {e!s}")
